...
$kr_ki4 = $this->db->query("SELECT * FROM tb_kr_ki4");
$ski2   = $this->db->query("SELECT * FROM tb_sikap_ki2, tb_siswa WHERE tb_sikap_ki2.siswa = tb_siswa.id_siswa");
...
foreach ($kr_ki4->result() as $kr4) {?>
              <th style="text-align: center; width: 100px;"><?=$kr4->nm_kriteria?></th>
              <?php $x++;}?>
          </tr>
