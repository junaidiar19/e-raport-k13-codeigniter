        ...
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
                <div class="login_heading">
                    <div class="user_avatar" style="margin-bottom: 12px;">
                        <img src="<?= base_url('images/' . $sekolah->logo) ?>" alt="">
                    </div>
                    <h3>Login Aplikasi E-Raport K-13 <br> <?= $sekolah->nama_sklh ?></h3>
                </div>
                <?php echo $this->session->flashdata('login'); ?>
                <form action="<?=base_url('login/ceklogin')?>" method="post">
                    <div class="uk-form-row">
                        <label for="login_username">Username</label>
                        <input class="md-input" type="text" name="username" autocomplete="off" />
                    </div>
                    <div class="uk-form-row">
